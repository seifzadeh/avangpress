...
/**
 * Class Avangpress_WooCommerce_Integration
 *
 * @ignore
 */
class Avangpress_WooCommerce_Integration extends Avangpress_Integration {
	...
	public function subscribe_from_woocommerce_checkout($order_id) {
		...
		// TODO: add billing address fields, maybe by finding AvangPress field of type "address"?
	...
	public function get_object_link($object_id) {
		return sprintf('<a href="%s">%s</a>', get_edit_post_link($object_id), sprintf(__('Order #%d', 'avangpress'), $object_id));
	}
