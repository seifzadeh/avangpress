...
/**
 * Class Avangpress_WPForms_Integration
 *
 * @ignore
 */
class Avangpress_WPForms_Integration extends Avangpress_Integration {
    ...
    public function listen_to_wpforms( $fields, $entry, $form_data ) {
        ...
        foreach( $fields as $field_id => $field ) {
            if( $field['type'] === 'mail' && $field['value_raw'] == 1 ) {
    ...
    public function subscribe_from_wpforms( $checkbox_field_id, $fields, $form_data ) {
        ...
        $mail_list_id = $form_data['fields'][$checkbox_field_id]['mail_list'];
