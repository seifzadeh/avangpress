...
/**
 * Class Avangpress_Custom_Integration
 * @ignore
 */
class Avangpress_Custom_Integration extends Avangpress_Integration {

	/**
	 * @var string
	 */
	protected $checkbox_name = 'avangpress-subscribe';
	...
	*/
	...
	public function listen() {
		...
		// (since they use the same "avangpress-subscribe" trigger)
