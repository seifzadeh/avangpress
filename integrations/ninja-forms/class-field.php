...
/**
 * Class Avangpress_Ninja_Forms_Field
 */
class Avangpress_Ninja_Forms_Field extends NF_Abstracts_Input {
	protected $_name = 'avangpress_optin';

	protected $_nicename = 'Mail';
	...
	public function __construct() {
		...
		$this->_nicename = __('AvangPress opt-in', 'avangpress');
	...
	public function custom_columns($value, $field) {
		...
		if ('avangpress_optin' == $field->get_setting('type')) {
