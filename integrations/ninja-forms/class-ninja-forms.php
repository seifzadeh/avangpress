 ...
 * @ignore
 */
class Avangpress_Ninja_Forms_Integration extends Avangpress_Integration {
	...
	public function add_hooks() {
	    add_action( 'avangpress_integration_ninja_forms_subscribe', array( $this, 'subscribe_from_ninja_forms' ), 10, 7 );
    }
