...
class Avangpress_Form_Previewer {
	...
	public function listen() {
		if( empty( $_GET['avangpress_preview_form'] ) ) {
            return;
        }

        try {
            $form = avangpress_get_form( $_GET['avangpress_preview_form'] );
        } catch( Exception $e ) {
            return;
        }  
	...
	public function load_preview() {
        ...
        $form_id = (int) $_GET['avangpress_preview_form'];
        status_header(200);
