...
class Avangpress_Queue {
    ...
    /**
     * Avangpress_Ecommerce_Queue constructor.
     *
     ...
     *
     * @return Avangpress_Queue_Job[] Array of jobs
     */
    public function all() {
    ...
    public function put( $data ) {
        ...
        // add job to queue
        $job = new Avangpress_Queue_Job( $data );
        $this->jobs[] = $job;
        $this->dirty = true;
        return true;
    }
     ...
     * Get all jobs in the queue
     *
     * @return Avangpress_Queue_Job|false
     */
    public function get() {
    ...
    /**
     * @param Avangpress_Queue_Job $job
     */
    public function delete( Avangpress_Queue_Job $job ) {
     ...
     * @param Avangpress_Queue_Job $job
     */
    public function reschedule( Avangpress_Queue_Job $job  ) {
        if( is_null( $this->jobs ) ) {
            $this->load();
        }
