...
class Avangpress_Mail_List {
	...
	/**
	 * @var string Web ID of this list in AvangPress.com
	 */
	public $web_id = '';
	...
	public function __construct($id, $name, $web_id = '') {
		...
		// add email field
		$email_field = new Avangpress_Mail_Merge_Field('Email Address', 'email', 'EMAIL', true);
	...
	/**
	 * Get link to this list in AvangPress
	 *
	 * @return string
	 */
	public function get_web_url() {
		return 'https://admin.mail.com/lists/members/?id=' . $this->web_id;
	}
