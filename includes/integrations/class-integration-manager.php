...
/**
 * Class Avangpress_Integration_Manager
 *
 * @ignore
 * @access private
 */
class Avangpress_Integration_Manager {
	...
	/**
	 * @var Avangpress_Integration_Fixture[]
	 */
	protected $integrations = array();

	/**
	 * @var Avangpress_Integration_Tags
	 */
	protected $tags;
	...
	*/
	public function __construct() {
		$this->tags = new Avangpress_Integration_Tags();
	}
	...
	public function initialize() {
		/*** @var Avangpress_Integration_Fixture $integration */
	 ...
	 *
	 * @return Avangpress_Integration_Fixture[]
	 * @throws Exception
	 */
	...
	public function register_integration( $slug, $class, $enabled = false ) {
		...
		$this->integrations[ $slug ] = new Avangpress_Integration_Fixture( $slug, $class, $enabled, $raw_options );
	}
	 ...
	 *
	 * @param Avangpress_Integration_Fixture $integration
	 *
	 * @return bool
	 */
	public function is_enabled( Avangpress_Integration_Fixture $integration ) {
	...
	private function load_options() {
		$options = (array) get_option( 'avangpress_integrations', array() );
         ...
         * @ignore
		 */
		return (array) apply_filters( 'avangpress_integration_options', $options );
	}
