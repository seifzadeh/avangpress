    ...
    (function() {
        ...
        5: [function(require, module, exports) {
            ...
            var FieldFactory = function FieldFactory(fields, i18n) {
                ...
                /**
                 * Register a field for a Avangpress grouping
                 *
        ...
        6: [function(require, module, exports) {
            ...
            module.exports = function(m, events) {
                ...
                var Field = function Field(data) {
                    ...
                    this.mailType = prop(data.mailType || '');
        ...
        7: [function(require, module, exports) {
            ...
            var domDirty = false;
            var editor;
            var element = document.getElementById('avangpress-form-content');
            var previewFrame = document.getElementById('avangpress-form-preview');
            var previewDom;
            var templateRegex = /\{[^{}]+\}/g;
            ...
            function setPreviewDom() {
                ...
                previewDom = frameContent.querySelector('.avangpress-form-fields');
            ...
            function updatePreview() {
                ...
                previewDom.dispatchEvent(new Event('avangpress-refresh'));
            }
        ...
        8: [function(require, module, exports) {
            ...
            var FormWatcher = function FormWatcher(m, editor, settings, fields, events, helpers) {
                ...
                function findRequiredFields() {
                    ...
                    // query fields required by AvangPress
        ...
        9: [function(require, module, exports) {
            ...
            function render() {
                ...
                var container = document.querySelector('.avangpress-notices');
                if (!container) {
                    container = document.createElement('div');
                    container.className = 'avangpress-notices';
            ...
            function init(editor, fields) {
                ...
                var groupingsNotice = function groupingsNotice() {
                    var text = "Your form contains old style <code>GROUPINGS</code> fields. <br /><br />Please remove these fields from your form and then re-add them through the available field buttons to make sure your data is getting through to AvangPress correctly.";
                ...
                var requiredFieldsNotice = function requiredFieldsNotice() {
                    ...
                    var text = '<strong>Heads up!</strong> Your form is missing list fields that are required in AvangPress. Either add these fields to your form or mark them as optional in AvangPress.';
        ...
        11: [function(require, module, exports) {
            ...
            var i18n = window.avangpress_forms_i18n;
            var m = window.avangpress.deps.mithril;
            var events = avangpress.events;
            var settings = avangpress.settings;
            var helpers = avangpress.helpers;

            var tabs = avangpress.tabs;
            ...
            m.mount(document.getElementById('avangpress-field-wizard'), fieldHelper);
            ...
            fieldsFactory.registerCustomFields(avangpress_vars.mail.lists);
            ...
            // expose some methods
            window.avangpress = window.avangpress || {};
            window.avangpress.forms = window.avangpress.forms || {};
            window.avangpress.forms.editor = editor;
            window.avangpress.forms.fields = fields;
