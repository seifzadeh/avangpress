(function() {
    ...
    (function() {
        ...
        1: [function(require, module, exports) {
            ...
            var avangpress = window.avangpress || {};
            var Gator = require('gator');
            var forms = require('./forms/forms.js');
            var config = window.avangpress_forms_config || {};
            ...
            Gator(document.body).on('submit', '.avangpress-form', function(event) {
                var form = forms.getByElement(event.target || event.srcElement);
                forms.trigger('submit', [form, event]);
                forms.trigger(form.id + '.submit', [form, event]);
            });

            Gator(document.body).on('focus', '.avangpress-form', function(event) {
                var form = forms.getByElement(event.target || event.srcElement);
            ...
            Gator(document.body).on('change', '.avangpress-form', function(event) {
                var form = forms.getByElement(event.target || event.srcElement);
            ...
            if (avangpress.listeners) {
                var listeners = avangpress.listeners;
                for (var i = 0; i < listeners.length; i++) {
                    forms.on(listeners[i].event, listeners[i].callback);
                }

                // delete temp listeners array, so we don't bind twice
                delete avangpress["listeners"];
            }

            // expose forms object
            avangpress.forms = forms;
            ...
            // expose avangpress object globally
            window.avangpress = avangpress;
        ...
        2: [function(require, module, exports) {
            ...
            function evaluate() {
                var elements = document.querySelectorAll('.avangpress-form [data-show-if], .avangpress-form [data-hide-if]');
                [].forEach.call(elements, toggleElement);
            }

            // re-evaluate conditional elements for change events on forms
            function handleInputEvent(evt) {
                if (!evt.target || !evt.target.form || evt.target.form.className.indexOf('avangpress-form') < 0) {
                    return;
                }
            ...
            exports.default = {
                'init': function init() {
                    ...
                    document.addEventListener('avangpress-refresh', evaluate, true);
        ...
        3: [function(require, module, exports) {
            ...
            Form.prototype.setResponse = function(msg) {
                this.element.querySelector('.avangpress-response').innerHTML = msg;
            };

            // revert back to original state
            Form.prototype.reset = function() {
                this.setResponse('');
                this.element.querySelector('.avangpress-form-fields').style.display = '';
                this.element.reset();
            };
        ...
        4: [function(require, module, exports) {
            ...
            function get(formId) {
                ...
                var formElement = document.querySelector('.avangpress-form-' + formId);
