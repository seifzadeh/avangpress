(function() {
    ...
    (function() {
        ...
        1: [function(require, module, exports) {
            ...
            // vars
            var context = document.getElementById('avangpress-admin');
            ...
            (0, _tlite2.default)(function(el) {
                return el.className.indexOf('avangpress-tooltip') > -1;
            });

            // list fetcher
            var ListFetcher = require('./admin/list-fetcher.js');
            var mount = document.getElementById('avangpress-list-fetcher');
            if (mount) {
            ...
            window.avangpress.deps = window.avangpress.deps || {};
            window.avangpress.deps.mithril = m;
            window.avangpress.helpers = helpers;
            window.avangpress.events = events;
            window.avangpress.settings = settings;
            window.avangpress.tabs = tabs;
        ...
        3: [function(require, module, exports) {
            ...
            function ListFetcher() {
                ...
                if (config.mail.api_connected && config.mail.lists.length === 0) {
                    this.fetch();
                }
            }
            ...
            ListFetcher.prototype.view = function() {
                return m('form', {
                    ...
                    type: "submit",
                    value: this.working ? i18n.fetching_mail_lists : i18n.renew_mail_lists,
                    className: "button",
                    disabled: !!this.working
                }), m.trust(' &nbsp; '), this.working ? [m('span.avangpress-loader', "Loading..."), m.trust(' &nbsp; '), m('em.help', i18n.fetching_mail_lists_can_take_a_while)] : '', this.done ? [this.success ? m('em.help.green', i18n.fetching_mail_lists_done) : m('em.help.red', i18n.fetching_mail_lists_error)] : ''])]);
            };
        ...
        4: [function(require, module, exports) {
            ...
            var Settings = function Settings(context, helpers, events) {
                ...
                var listInputs = context.querySelectorAll('.avangpress-list-input');
                var lists = avangpress_vars.mail.lists;
                var selectedLists = [];
        ...
        5: [function(require, module, exports) {
            ...
            var Tabs = function Tabs(context) {
                ...
                function _open(tab, updateState) {
                    ...
                    if (tab.id === 'fields' && window.avangpress && window.avangpress.forms && window.avangpress.forms.editor) {
                        avangpress.forms.editor.refresh();
                    }
